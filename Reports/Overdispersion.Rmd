...
<div class = "jumbotron">
<p>So when someone claims about the economic impact of lockdowns, now you know that :</p>

<ul>
 <li>the COVID epidemic is largely driven by clusters, so controlling those is key.</li>
 <li>transmission chains can diminsish fast, but can explode fast as well. Much of that is coincidence.</li>
